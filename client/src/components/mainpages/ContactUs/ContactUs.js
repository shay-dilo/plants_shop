    ...
    <div style={{ backgroundImage: `url(${backround1})` }}>
      <div>
        ...
        >
          ...
          <h3 style={{ fontFamily: "Comic Sans MS, Comic Sans, cursive" }}>
            shaydilouya@gmail.com
          </h3>
        </div>
        <br />
        <br />
          ...
          <form onSubmit={sendEmail}>
            ...
            <div className="w3-container">
              <div>
                <input
                  type="text"
                  className="w3-input w3-border w3-transparent"
                  placeholder="Name"
                  name="name"
                  required
                />
              ...
              <div>
                <input
                  type="submit"
                  className="w3-btn w3-transparent"
                  value="Send Message"
                ></input>
              </div>
            </div>
